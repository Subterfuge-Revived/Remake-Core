...
namespace SubterfugeCore.Core.Entities.Specialists
{
    ...
    public class Specialist : IOwnable
    {
        ...
        public List<EffectDelta> GetEffects(GameState state, ICombatable friendly, ICombatable enemy)
        {
            var effectsList = new List<EffectDelta>();
            foreach(SpecialistEffect effect in this._specialistEffects)
            {
                effectsList.AddRange(effect.GetForwardEffectDeltas(state, friendly, enemy));
