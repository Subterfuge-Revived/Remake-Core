...
namespace SubterfugeServerConsole.Responses
{
    ...
    {
        public static SubterfugeCore.Models.GameEvents.ResponseStatus createResponse(ResponseType type)
        {
            if (type == ResponseType.SUCCESS)
            {
                return new SubterfugeCore.Models.GameEvents.ResponseStatus()
                {
                    IsSuccess = true,
